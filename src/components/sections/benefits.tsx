...
function BenefitsSection() {
  return (
    <section className="relative z-0 mx-auto max-w-[1200px] overflow-hidden">
      <h2 className="font-secondary mb-4 text-center text-6xl font-semibold">
        Why You&apos;ll Love CodeSculpt
      </h2>
      ...
      <div className="mb-44 grid auto-rows-[20rem] grid-cols-3 gap-4">
        <div className="to-background relative col-span-2 h-full w-full overflow-hidden rounded-xl border">
          ...
          <div className="pointer-events-none absolute bottom-5 left-10 right-10 h-[6.26rem]">
            <h3 className="font-secondary mb-2 text-3xl font-semibold">
              Expert team
            </h3>
        ...
        <div className="to-background group relative h-full w-full overflow-hidden rounded-xl border bg-gradient-to-b from-transparent from-60%">
          <div className="relative -z-10 h-full w-full">
            <div className="absolute left-1/2 top-[30px] aspect-square w-[150%] -translate-x-1/2 rotate-[-23deg] rounded-full border-2 transition-transform duration-500 ease-in-out group-hover:rotate-0">
              <BiDesktop className="bg-background text-muted-foreground absolute left-1/2 top-0 h-10 w-10 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 p-1 transition-colors duration-500 group-hover:text-red-500" />
            </div>
            ...
            <div className="absolute left-1/2 top-[90px] aspect-square w-[150%] -translate-x-1/2 rotate-[2deg] rounded-full border-2 transition-transform duration-500 ease-in-out group-hover:rotate-0">
              <BiCode className="bg-background text-muted-foreground absolute left-1/2 top-0 h-10 w-10 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 p-1 transition-colors duration-500 group-hover:text-yellow-500" />
            </div>
            ...
            <div className="absolute left-1/2 top-[150px] aspect-square w-[150%] -translate-x-1/2 rotate-[25deg] rounded-full border-2 transition-transform duration-500 ease-in-out group-hover:rotate-0">
              <BiCloud className="bg-background text-muted-foreground absolute left-1/2 top-0 h-10 w-10 -translate-x-1/2 -translate-y-1/2 rounded-full border-2 p-1 transition-colors duration-500 group-hover:text-green-500" />
            </div>
          </div>
        ...
        <div className="to-background group relative h-full w-full overflow-hidden rounded-xl border bg-gradient-to-b from-transparent from-60%">
          <div className="text-muted-foreground relative -z-10 h-full w-full">
            <SparklesCore
        ...
        <div className="to-background group relative col-span-2 h-full w-full overflow-hidden rounded-xl border bg-gradient-to-b from-transparent from-60%">
          <div className="text-muted-foreground group relative h-full w-full">
